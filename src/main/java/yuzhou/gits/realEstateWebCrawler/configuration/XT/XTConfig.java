package yuzhou.gits.realEstateWebCrawler.configuration.XT;
...
public class XTConfig {
	...
	public final static String projPageInfoSelector = "#page > div > ul";
	public final static Pattern pageTotalPattern = Pattern.compile("共(\\d+)页");
